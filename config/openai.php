...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | SKASEN Priority Classification
    |--------------------------------------------------------------------------
    |
    | Configuration for the priority classifier feature.
    |
    */

    'model_priority' => env('OPENAI_MODEL_PRIORITY', 'gpt-4o-mini'),
    'skasen_vector_store_id' => env('SKASEN_VECTOR_STORE_ID'),
];
