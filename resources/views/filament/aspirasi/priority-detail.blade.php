@php
    ...
    // warna bar confidence (optional, tapi bagus)
    $confidenceBarClass = match (true) {
        is_null($confidencePercent) => 'bg-gray-300',
...
<div class="space-y-5">
    ...
    @else
        {{-- Header ringkas: judul + badge prioritas (tanpa confidence biar tidak dobel) --}}
        ...
        {{-- Ringkas 2 kolom: Prioritas & Confidence --}}
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4">
                ...
                <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-gray-100">
                    <div
                        class="h-full rounded-full {{ $confidenceBarClass }}"
